...
Dropt.list(name)
  .add(Dropt.rule()
      ...
      .addDrop(Dropt.drop()
          .selector(Dropt.weight(100), "EXCLUDED", 2)
          .items(dropItemsList, Dropt.range(2, 5))
          .xp("REPLACE", Dropt.range(0, 5))
      )
      .addDrop(Dropt.drop()
          .selector(Dropt.weight(1000), "EXCLUDED", 3)
          .items(dropItemsList, Dropt.range(4, 8))
          .xp("REPLACE", Dropt.range(0, 5))
      )
  );
}
...
Dropt.list(name)
  .add(Dropt.rule()
      ...
      .addDrop(Dropt.drop()
          .selector(Dropt.weight(100), "EXCLUDED", 2)
          .items(dropItemsList, Dropt.range(4, 7))
          .xp("REPLACE", Dropt.range(1, 8))
      )
      .addDrop(Dropt.drop()
          .selector(Dropt.weight(1000), "EXCLUDED", 3)
          .items(dropItemsList, Dropt.range(5, 10))
          .xp("REPLACE", Dropt.range(1, 8))
      )
  );
}
